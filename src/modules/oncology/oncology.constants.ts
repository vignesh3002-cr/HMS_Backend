...
export const ENCOUNTER_OPEN_STATUS = "OPEN";
export const ENCOUNTER_RECENCY_WINDOW_DAYS = 30;

// Cancer types where the IHC block (Block C) is shown, per design guide
// Section 6.1 Step 3 / Section 8's Block C trigger.
export const IHC_BLOCK_CANCER_TYPES = [
...
export function isPositiveLike(value: string | null | undefined): boolean {
...
export function isNotDoneOrPending(value: string | null | undefined): boolean {
...
export function isLost(value: string | null | undefined): boolean {
...
export function her2IhcScore(value: string | null | undefined): string | null {
