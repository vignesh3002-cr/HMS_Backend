...
import { patientDocumentService, PatientDocumentService } from "./patientDocument.service";

export class PatientDocumentController {
  constructor(private service: PatientDocumentService = patientDocumentService) {}
  ...
  getPatientDocuments = async (req: Request, res: Response) => {
    try {
...
export const patientDocumentController = new PatientDocumentController();
