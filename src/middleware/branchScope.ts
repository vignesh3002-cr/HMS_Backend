...
import { TOP_LEVEL_ADMIN_ROLES, BRANCH_RESTRICTED_ROLES } from "../permissions/roles";

const UNRESTRICTED_ROLES = TOP_LEVEL_ADMIN_ROLES;
...
export const branchScope: RequestHandler = async (req, res, next) => {
    ...
    try {
        ...
        const isBranchRestricted = BRANCH_RESTRICTED_ROLES.some((r) => r.toLowerCase() === role);
