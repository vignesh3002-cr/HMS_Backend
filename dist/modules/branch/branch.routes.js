...
router.get("/assignable-admins", auth_middleware_1.authenticate, (0, authorize_1.authorize)(...TOP_LEVEL_ADMIN_ROLES), branch_validation_1.getAssignableAdminsValidation, controller.getAssignableAdmins.bind(controller));
// Existing routes
router.get("/", controller.getAllBranches.bind(controller));
router.get("/:branchId", controller.getBranchById.bind(controller));
router.post("/", branch_validation_1.createBranchValidation, controller.createBranch.bind(controller));
...
router.patch("/:branchId/admin", auth_middleware_1.authenticate, (0, authorize_1.authorize)(...TOP_LEVEL_ADMIN_ROLES), branch_validation_1.assignAdminValidation, controller.assignAdmin.bind(controller));
// NEW: Explicitly unassign a Branch Admin (the "None" state) - requires a top-level admin role
router.patch("/admin/:userId/unassign", auth_middleware_1.authenticate, (0, authorize_1.authorize)(...TOP_LEVEL_ADMIN_ROLES), controller.unassignAdmin.bind(controller));
