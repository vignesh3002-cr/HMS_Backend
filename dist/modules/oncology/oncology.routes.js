...
router.get("/staging-details", auth_middleware_1.authenticate, (0, authorize_1.authorize)("oncology.diagnosis.read"), oncology_validation_1.listStagingDetailsValidation, controller.listStagingDetails.bind(controller));
