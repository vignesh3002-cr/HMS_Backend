...
router.get("/reschedule-queue", auth_middleware_1.authenticate, (0, authorize_1.authorize)("doctor.transfer"), (0, authorize_1.authorizeRoles)(...doctorTransfer_routes_1.DOCTOR_TRANSFER_ROLES), doctorTransfer_validation_1.getRescheduleQueueValidation, transferController.getRescheduleQueue.bind(transferController));
router.put("/reschedule/:appointmentId", auth_middleware_1.authenticate, (0, authorize_1.authorize)("doctor.transfer"), (0, authorize_1.authorizeRoles)(...doctorTransfer_routes_1.DOCTOR_TRANSFER_ROLES), doctorTransfer_validation_1.processRescheduleActionValidation, transferController.processRescheduleAction.bind(transferController));
router.post("/transfer-preview", auth_middleware_1.authenticate, (0, authorize_1.authorize)("doctor.transfer"), (0, authorize_1.authorizeRoles)(...doctorTransfer_routes_1.DOCTOR_TRANSFER_ROLES), doctorTransfer_validation_1.transferPreviewValidation, transferController.transferPreview.bind(transferController));
