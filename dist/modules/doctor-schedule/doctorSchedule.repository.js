...
exports.doctorScheduleRepository = exports.DoctorScheduleRepository = void 0;
...
class DoctorScheduleRepository {
     ...
     */
    async findActiveScheduleChanges(employeeId) {
     ...
     * on a specific date.
     */
    async findScheduleChangesByDate(employeeId, date) {
        return prisma_1.default.doctor_schedule_change.findMany({
            where: {
                employee_id: employeeId,
                change_date: date,
     ...
     */
    async findScheduleChangeById(changeId) {
        return prisma_1.default.doctor_schedule_change.findUnique({
            where: {
                change_id: changeId,
            },
        });
     ...
     */
    async findActiveScheduleChangesForBranchDate(employeeId, branchId, date) {
        return prisma_1.default.doctor_schedule_change.findMany({
            where: {
                employee_id: employeeId,
                branch_id: branchId,
     ...
     * record is modified.
     */
    async updateScheduleChange(changeId, data) {
     ...
     */
    async deactivateScheduleChange(changeId) {
        return prisma_1.default.doctor_schedule_change.update({
            where: {
                change_id: changeId,
            },
     ...
     */
    async findDoctorSchedules(employeeId, branchId, dayOfWeek) {
...
exports.DoctorScheduleRepository = DoctorScheduleRepository;
exports.doctorScheduleRepository = new DoctorScheduleRepository();
